...
/*GetTeamsOK A array of team objects
...
type GetTeamsOK struct {
	...
	/*
	  In: Body
	*/
	Payload *GetTeamsOKBody `json:"body,omitempty"`
}
...
func (o *GetTeamsOK) WithPayload(payload *GetTeamsOKBody) *GetTeamsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get teams o k response
func (o *GetTeamsOK) SetPayload(payload *GetTeamsOKBody) {
	o.Payload = payload
}
